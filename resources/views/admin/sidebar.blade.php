<div class="main-menu-content">
  <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      <li class="@yield('pembelanjaanactive') nav-item"><a href="{{ route('admin.index') }}"><i class="feather icon-shopping-cart"></i><span class="menu-title" data-i18n="Pembelanjaan">Pembelanjaan</span></a></li>
